...
try:
    with open(CSV_FILE, 'x', newline='') as file:
        ...
        writer.writerow(["Differential1", "Differential2", "Differential3", "Local_Timestamp"])
...
def notification_handler(sender, data):
    ...
    try:
        ...
        # Print the values
        print(
            f"Differential1: {differential1}, Differential2: {differential2}, Differential3: {differential3}, Local_Timestamp: {local_timestamp}")
        # Log to CSV
